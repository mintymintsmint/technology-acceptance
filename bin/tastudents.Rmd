...
plot_BI_VU <- ggplot(data, aes(x = BI, y = VU)) +  # label = Name
                ...
                geom_smooth(na.rm = T,
                            ...
                            colour = "green4",
                            show.legend = T) + 
                labs(title = "Non-Linear Relationship between Behavioral Intention and Voluntariness of Moodle Use",
                     caption = "Data: umfrage.up",
...
plot_OT_PE <- ggplot(OT_data_new, aes(x = OT_number, y = PE)) +
                ...
                geom_smooth(na.rm = T,
                            ...
                            colour = "coral3",
                            show.legend = T) + 
                labs(title = "Relationship between Average Perceived Ease of Use and Number of Devices/Software Used",
                     caption = "Data: umfrage.up",
                     x = "Number of Devices / Software of Personal Ecosystem",
                     y = "Perceived Ease of Use") +
                theme(plot.title = element_text(color = "royalblue4", size = 8, face = "bold"),
                      plot.caption  = element_text(face = "italic"))
...
plot_OT_PU <- ggplot(OT_data_new, aes(x = OT_number, y = PU)) +
                ...
                geom_smooth(na.rm = T,
                            ...
                            colour = "coral3",
                            show.legend = T) + 
                labs(title = "Relationship between Average Perceived Usefulness and Number of Devices/Software Used",
                     caption = "Data: umfrage.up",
                     x = "Number of Devices / Software of Personal Ecosystem",
                     y = "Perceived Usefulness") +
                theme(plot.title = element_text(color = "royalblue4", size = 8, face = "bold"),
...
TODO: check assumptions for linear regression